...
import { adicionaNota, alteraNota, deletaNota } from "../servicos/Notas"
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={estilos.modal}>
              ...
              <View style={estilos.modalBotoes}>
                <TouchableOpacity style={estilos.modalBotaoSalvar} onPress={() => { notaParaAtualizar ? atualizaNota() : salvaNota()}}>
                  <Text style={estilos.modalBotaoTexto}>Salvar</Text>
                </TouchableOpacity>
                { notaParaAtualizar ? <TouchableOpacity style={estilos.modalBotaoDeletar} onPress={() => { excluirNota()}}>
